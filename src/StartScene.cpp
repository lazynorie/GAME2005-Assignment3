...
void StartScene::start()
{
	...
	m_pStartLabel = new Label("A3 - 2D Collision Detection and Response", "Consolas", 40, blue, glm::vec2(500.0f, 200.0f));
	m_pStartLabel->setParent(this);
	addChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("Press 1 for Stage 1", "Consolas", 25, blue, glm::vec2(500.0f, 300.0f));
	m_pInstructionsLabel->setParent(this);
	addChild(m_pInstructionsLabel);

	m_pInstructionsLabel = new Label("Press 2 for Stage 2", "Consolas", 25, blue, glm::vec2(500.0f, 330.0f));
	m_pInstructionsLabel->setParent(this);
	addChild(m_pInstructionsLabel);
